...
// talonSRX
#define FR_STEER_MOTOR_ID 1
#define BR_STEER_MOTOR_ID 2
#define BL_STEER_MOTOR_ID 3
...
#define BR_DRIVE_MOTOR_ID 2
#define BL_DRIVE_MOTOR_ID 3
#define FL_DRIVE_MOTOR_ID 4
