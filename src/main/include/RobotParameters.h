...
namespace RobotParameters {
    ...
    // HatchSlide
    static constexpr double k_beltCircumference = 1.128 * 3.14 * (8 / 9.0); //1.625in * pi
    ...
    // CargoIntake
    static constexpr double k_cargoIntakeThresholdIn = 300; // point where it's no longer safe to move elevator down onto it
